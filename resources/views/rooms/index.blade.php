...
<head>
    ...
    <style>
        ...
        .cover h1 {
            font-size: 48px;
            margin-bottom: 20px;
            text-shadow: 2px 2px #fff; /* Efek bayangan teks */
        }
        ...
        .cover button {
            ...
            color: #F48FB1; /* Warna teks tombol pink */
            text-shadow: none; /* Hapus efek bayangan teks */
            border: 2px solid #F48FB1; /* Garis pinggir tombol pink */
            transition: all 0.3s ease; /* Transisi animasi */
            z-index: 1; /* Layer di atas elemen lain */
        }

        .cover button:hover {
            background-color: #F06292; /* Warna background tombol hover */
        ...
        .patients-container {
            ...
            border: 2px solid #F48FB1; /* Garis pinggir pink */
